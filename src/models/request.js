...
var request = new Schema({
    ...
    fields : {type : Object},
    status : {type : String, enum : ['created','published', 'approved', 'changed', 'assignedtopartners', 'assignedtocaseofficer', 'offerreceived', 'offeraccepted', 'closed'], default : 'created'},
    statusLog : [status],
    ...
    owner : {type: Object},
    tracktion : {type : Object}
});

request.methods.setstatus = function(user, status, description, cb) {
